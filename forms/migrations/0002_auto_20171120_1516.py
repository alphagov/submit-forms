# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-11-20 15:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='FieldType',
            fields=[
                ('fieldtype', models.IntegerField(primary_key=True, serialize=False)),
                ('name', models.CharField(blank=True, default='', max_length=256)),
                ('description', models.TextField(blank=True, default='')),
        ...
        migrations.AddField(
            model_name='question',
            name='max_length',
            field=models.PositiveIntegerField(default=1, help_text='Maximum number of times the fieldgroup maybe repeated'),
        ),
        migrations.AddField(
            model_name='question',
            name='min_length',
            field=models.PositiveIntegerField(default=1, help_text='Minimum number of times the fieldgroup maybe repeated'),
        ),
        ...
        migrations.AddField(
            model_name='field',
            name='fieldtype',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='forms.FieldType'),
        ),
        migrations.AddField(
            model_name='question',
            name='fieldgroup',
